    ...
    public Collection<ReportItem> extract() throws IOException {
        ...
        for (Node file : fileNodes) {
            ...
            for (Node violation : violationNodes) {
                ...
                reportItem.setBeginLine(CommonUtil.convertStringToIntSafety(e.attributeValue("beginline")));
                reportItem.setEndLine(CommonUtil.convertStringToIntSafety(e.attributeValue("endline")));
                reportItem.setBeginColumn(CommonUtil.convertStringToIntSafety(e.attributeValue("begincolumn")));
                reportItem.setEndColumn(CommonUtil.convertStringToIntSafety(e.attributeValue("endcolumn")));
